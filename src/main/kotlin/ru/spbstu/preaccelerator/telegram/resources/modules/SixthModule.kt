...
fun ModuleConfigBuilder.sixthModule() {
    module("Юридические основы. Управление проектами.", 7.days) {
        ...
        task(
            "Выберите юрисдикцию и организационно-правовую форму вашей компании\n" +
                    "Определитесь как вы будете распределять доли в компании\n" +
                    "Будете ли вы предусматривать опционы для сотрудников? В каком размере?\n" +
                    "Каким образов будете защищать свою интеллектуальную собственность и в какой юрисдикции? Оцените примерно расходы, которые вы понесете для защиты интеллектуальной собственности.\n"
        )
        lecture(
        ...
        additionalInfo(
            "Обзор методов agile https://vc.ru/u/117584-dmitriy-gukov/135749-obzor-metodov-agile\n" +
                    ...
                    "Why the secret to success is setting the right goals, Джон Дорр https://youtu.be/L4N1q4RNi9I\n" +
                    "Чек-лист с полезными материалами по созданию OKR от компании Carrot quest (выложено в доп материалах к Модулю, надо сделать ссылку на файл)\n" +
                    "Шаблон «Трекер OKR» (выложено в доп материалах к Модулю, надо сделать ссылку на файл)\n"
        )
    }
}