...
fun ModuleConfigBuilder.firstModule() {
    module(
        "Национальная технологическая инициатива\\. Жизненный цикл проекта\\. Команда проекта\\. Технологии", 7.days,
        ...
        task(
            ...
            "«Чек\\-лист Рынки и сквозные технологии НТИ»"
        )
        lecture(
        ...
        task(
            ...
            "«Готовность продукта TRL\\-MRL\\-CRL»"
        )
    }
}
