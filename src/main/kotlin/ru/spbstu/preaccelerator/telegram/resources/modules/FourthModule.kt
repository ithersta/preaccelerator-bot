    ...
    module("Коммерциализация", 7.days) {
        ...
        additionalInfo(
            "Бизнес-модель А. Остервальдера https://www.coursera.org/lecture/strategichesky-menegment/liektsiia-1-biznies-modiel-a-ostierval-diera-z03O2 \n" +
                    ...
                    "Девять бизнес-моделей и какие метрики хотят видеть инвесторы — Ану Харихаран https://www.youtube.com/watch?v=OVBoHfX-pXk \n" +
        ...
        task(
            "Опишите бизнес-модель вашего проекта/продукта, используя Шаблон “Бизнес-модель”\n" +
                    "Если вы уже провели проблемные интервью, отметьте гипотезы, которые уже подтвердились. Проведите 1-2 дополнительных интервью.\n" +
                    "Обновите бизнес-модель своего проекта по результатам проверки гипотез.\n"
        )
        lecture(
        ...
        additionalInfo(
            "Руководство по настройке рекламы в Яндекс.Директе https://direct.yandex.ru\n" +
                    ...
                    "М. Зобнина, Е. Васильева. Маркетинг и управление продуктом на цифровых рынках: геренация и проверка идей через CustDev, дизайн-мышление и расчеты юнит-экономики.\n" +
                    "М. Стелзнер. Контент-маркетинг. Новые методы привлечения в эпоху Интернета.\n" +
                    "Д. Халилов. Маркетинг в социальных сетях.\n"
        )
        task(
            "Если у вас есть данные по каналам, привлечению и продажам, то составьте воронку AAARRR по вашему продукту/проекту, используя Шаблон “Воронка АААRRR”. \n" +
                    "Проанализируйте воронку и сформулируйте выводы\n" +
                    "поймите нужно ли “чинить” воронку\n" +
                    "с помощью каких целевых метрик поймете, что результат улучшился\n" +
                    "Если у вас нет реальных данных по воронке АААRRR, то смоделируйте ее (выдвиньте гипотезы).\n" +
                    "На первом этапе можно выбрать 1 канал, который вы можете быстро проверить и смоделировать воронку только по нему.\n" +
                    "Определите метрики для этого канала (цели, источники трафика, метрика для анализа)\n" +
                    "Проведите эксперимент в этом канале (например, тестовая реклама/написание писем на e-mail/холодные звонки итд)\n" +
                    "Сравните смоделированную воронку (гипотезы) и реальный результат, внесите корректировки.\n" +
        ...
        task(
            "Обобщите результаты домашней работы по оценке рынка, анализу конкурентов и тестированию каналов.\n" +
                    "Заполните Marketing Canvas, используя Шаблон “Marketing Canvas”.\n" +
                    "Создайте карту трафика, оцените необходимые объемы трафика с точки зрения вашей оценки рынка.\n"
        )
    }
}