...
fun ModuleConfigBuilder.fourthModule() {
    module("Коммерциализация", 7.days) {
        ...
        task(
            "Если у вас есть данные по каналам, привлечению и продажам, то составьте воронку AAARRR по вашему продукту/проекту, используя [Шаблон “Воронка АААRRR”](https://docs.google.com/document/d/1e592nDaYAep0XXGFYgZvTezxYY9SxJL92cyy7Cp9VNk/edit?usp=sharing). \n" +
                    "Проанализируйте воронку и сформулируйте выводы, поймите нужно ли “чинить” воронку, с помощью каких целевых метрик поймете, что результат улучшился\n" +
