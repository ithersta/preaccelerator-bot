...
object MessageStrings : KoinComponent {
    ...
    object Start {
        const val AskContact = "Добро пожаловать в телеграм\\-бот предакселератора НТИ\\.\n" +
                "Чтобы начать путь к успешному стартапу длиной в 8 недель, необходимо *нажать на кнопку* и поделиться вашим номером телефона\\. " +
                "Это позволит пройти идентификацию\\."
        const val NoContactReceived = "Чтобы поделиться номером телефона, нажмите на кнопку снизу"
