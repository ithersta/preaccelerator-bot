    ...
    module("Определение ключевой деятельности компании", 7.days) {
        ...
        task(
            "1. Проанализируйте ваш продукт/проект\n" +
                    ...
                    "3. Заполните предложенный шаблон «Описание идеи» (активная ссылка)\n"
        )
        lecture(
        ...
        task(
            "Проанализируйте свой продукт/проект и подумайте кто может быть целевой аудиторией? Какие потребности у этих людей? На каком рынке вы будете работать? B2B (вы будете продавать компаниям?) или B2C (вы будете продавать конечным потребителям физическим лицам?)\n" +
                    ...
                    "Заполните один из предложенных шаблонов «Портрет целевой аудитории» (активная ссылка)\n"
        )
        lecture(
        ...
        additionalInfo(
            "Как проверять гипотезы с помощью проблемных интервью: пошаговая инструкция: https://vc.ru/marketing/156573-kak-proveryat-gipotezy-s-pomoshchyu-problemnyh-intervyu-poshagovaya-instrukciya\n" +
                    ...
                    "Promobot: как российские роботы покорили целый мир:\n" +
                    "https://www.youtube.com/watch?v=jVuW06R7KS0&feature=emb_logo\n" +
        ...
        task(
           "Все, что вы написали в Задании 2 (используя шаблон “Портрет целевой аудитории”) - это ваши гипотезы\n" +
                   ...
                   "Для проведения интервью и выводах после него можете использовать Шаблон “Проблемное интервью и кластеризация результатов” (активная ссылка)\n"
        )
        task(
            "Проанализируйте данные проведенных проблемных интервью\n" +
                    ...
                    "Вы можете использовать шаблон “MVP продукта” (активная ссылка)\n"
        )
    }
}