...
fun ModuleConfigBuilder.secondModule() {
    module("Определение ключевой деятельности компании", 7.days) {
        ...
        task(
            "Проанализируйте свой продукт/проект и подумайте кто может быть целевой аудиторией? Какие потребности у этих людей? На каком рынке вы будете работать? B2B (вы будете продавать компаниям?) или B2C (вы будете продавать конечным потребителям физическим лицам?)\n" +
                    "Выделите 1-3 сегмента\n" +
                    "По каждому сегменту составьте Портрет потребителя и сформулируйте ценностное предложение\n" +
                    "Заполните один из предложенных шаблонов [«Портрет целевой аудитории»](https://docs.google.com/document/d/1vg7bHvyKxfjJjDN1Q1QbdAEXPQVcsZ9o/edit?usp=sharing&ouid=117136603392830305877&rtpof=true&sd=true)\n"
        )
        lecture(
        ...
        task(
           "Все, что вы написали в Задании 2 (используя шаблон “Портрет целевой аудитории”) - это ваши гипотезы\n" +
                   "Напишите к ним список потенциальных вопросов интервью для проверки этих гипотез\n" +
                   "Проведите 3-5 проблемных интервью\n" +
                   "Выпишите все главные мысли, факты и инсайты от потенциальных пользователей после интервью\n" +
                   "Сделайте вывод подтвердились ли ваши гипотезы после интервью?\n" +
                   "Если подтвердились не все гипотезы, переформулируйте/уточните результаты вашего предыдущего задания (Портрет целевой аудитории и ценностное предложение)\n" +
                   "Для проведения интервью и выводах после него можете использовать Шаблон [“Проблемное интервью и кластеризация результатов”](https://docs.google.com/document/d/1TSoSTwIO56MmB2kRH5o-JYh2p_ElEM3N/edit?usp=sharing&ouid=117136603392830305877&rtpof=true&sd=true)\n"
        )
        task(
            "Проанализируйте данные проведенных проблемных интервью\n" +
                    "Решите, что является обязательным и желательным в функционале вашего продукта\n" +
                    "Определитесь какой минимальный функционал необходим\n" +
                    "Определитесь будете ли вы использовать существующие сервисы/готовые решения для вашего MVP\n" +
                    "Решите какой тип MVP больше всего подходит для вашего продукта\n" +
                    "Вы можете использовать шаблон [“MVP продукта”](https://docs.google.com/document/d/1Buk73Q5Sni-0INC1WltR1feZS7MiqWjp/edit?usp=sharing&ouid=117136603392830305877&rtpof=true&sd=true)\n"
        )
    }
}